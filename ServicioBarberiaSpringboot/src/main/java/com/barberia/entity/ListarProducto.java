...
public class ListarProducto
{
  ...
  public ListarProducto(int aidProducto, String cTipo, String dProducto, String eMarca, String estado, int fCant, double gPrecio, String hDescrip)
  {
  ...
  public String geteMarca() { return eMarca; }
