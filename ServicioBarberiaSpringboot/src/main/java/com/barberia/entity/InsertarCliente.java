...
public class InsertarCliente
{
  ...
  public InsertarCliente(String aNombre, String bApellido, String cTelefono, String dDni, String eEmail, String fDirecion)
  {
  ...
  public String getfDirecion() { return fDirecion; }
