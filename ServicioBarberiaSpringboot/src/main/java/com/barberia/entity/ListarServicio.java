...
public class ListarServicio
{
  ...
  public ListarServicio(int aidServicio, String bcodServicio, String cServicio, String dEstado, int eDuracion, double fPrecio, String gDescripcion)
  {
  ...
  public void setAidServicio(int aidServicio) { this.aidServicio = aidServicio; }
  
  public String getBcodServicio() {
    return bcodServicio;
  }
  
  public void setBcodServicio(String bcodServicio) { this.bcodServicio = bcodServicio; }
  ...
  public void seteDuracion(int eDuracion) { this.eDuracion = eDuracion; }
  
  public double getfPrecio() {
    return fPrecio;
  }
  
  public void setfPrecio(double fPrecio) { this.fPrecio = fPrecio; }
  
  public String getgDescripcion() {
    return gDescripcion;
  }
  
  public void setgDescripcion(String gDescripcion) { this.gDescripcion = gDescripcion; }
}
