...
public class BarberoModel
{
  ...
  public static BarberoModel getInstance() { if (stdregd == null) {
  ...
  public List<com.barberia.entity.ListarBarberoInterno> getBarberoRecords()
  {
    ...
    try
    {
      ...
      while (rslt.next()) {
        BarberoRecords.add(new com.barberia.entity.ListarBarberoInterno(rslt
          .getString(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
  ...
  public List<ListarBarbero> getBarberoR()
  {
    ...
    try
    {
      ...
      ResultSet rslt = dbCon.getResultSet(SQLQuery, conn);
      while (rslt.next()) {
        BarberoR.add(new ListarBarbero(rslt
          .getInt(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
  ...
  public List<BuscarBarberoInterno> getBarberoByWords(String words)
  {
    ...
    try
    {
      ...
      while (rslt.next()) {
        BarberoSearch.add(new BuscarBarberoInterno(rslt
          .getInt(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
  ...
  public List<BuscarBarbero> getBarbByWords(String words)
  {
    ...
    try
    {
      ...
      ResultSet rslt = clbl.executeQuery();
      while (rslt.next()) {
        BarberoS.add(new BuscarBarbero(rslt
          .getString(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
  ...
  public List<RecuperarBarberoInterno> getBarbero(int id)
  {
    ...
    try
    {
      ...
      while (rslt.next()) {
        BarberoGet.add(new RecuperarBarberoInterno(rslt
          .getInt(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
