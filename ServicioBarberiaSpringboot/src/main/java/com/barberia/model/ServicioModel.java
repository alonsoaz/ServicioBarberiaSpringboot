...
public class ServicioModel
{
  ...
  public static ServicioModel getInstance() { if (stdregd == null) {
  ...
  public List<ListarServicioInterno> getServicioRecords()
  {
    ...
    try
    {
      ...
      while (rslt.next()) {
        ServicioRecords.add(new ListarServicioInterno(rslt
          .getInt(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
  ...
  public List<ListarServicio> getServicioR()
  {
    ...
    try
    {
      ...
      ResultSet rslt = dbCon.getResultSet(SQLQuery, conn);
      while (rslt.next()) {
        ServicioR.add(new ListarServicio(rslt
          .getInt(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
  ...
  public List<BuscarServicioInterno> getServicioByWords(String words)
  {
    ...
    try
    {
      ...
      while (rslt.next()) {
        ServicioSearch.add(new BuscarServicioInterno(rslt
          .getInt(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
  ...
  public List<com.barberia.entity.BuscarServicio> getServByWords(String words)
  {
    ...
    try
    {
      ...
      ResultSet rslt = clbl.executeQuery();
      while (rslt.next()) {
        ServicioS.add(new com.barberia.entity.BuscarServicio(rslt
          .getInt(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
  ...
  public List<RecuperarServicioInterno> getServicio(int id)
  {
    ...
    try
    {
      ...
      while (rslt.next()) {
        ServicioGet.add(new RecuperarServicioInterno(rslt
          .getString(1), rslt
          .getInt(2), rslt
          .getInt(3), rslt
          .getDouble(4), rslt
