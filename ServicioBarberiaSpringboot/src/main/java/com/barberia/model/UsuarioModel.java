...
public class UsuarioModel
{
  ...
  public static UsuarioModel getInstance() { if (stdregd == null) {
  ...
  public List<com.barberia.entity.ListarUsuario> getUsuarioRecords()
  {
    ...
    try
    {
      ...
      while (rslt.next()) {
        usuarioRecords.add(new com.barberia.entity.ListarUsuario(rslt
          .getString(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
  ...
  public List<BuscarUsuario> getUsuarioByWords(String words)
  {
    ...
    try
    {
      ...
      while (rslt.next()) {
        usuarioSearch.add(new BuscarUsuario(rslt
          .getString(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
  ...
  public List<RecuperaraUsuario> getUsuario(int id)
  {
    ...
    try
    {
      ...
      while (rslt.next()) {
        usuarioGet.add(new RecuperaraUsuario(rslt
          .getString(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
