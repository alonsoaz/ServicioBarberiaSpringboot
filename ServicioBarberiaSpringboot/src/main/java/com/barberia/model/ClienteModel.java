...
public class ClienteModel
{
  ...
  public static ClienteModel getInstance() { if (stdregd == null) {
  ...
  public List<ListarClienteInterno> getClienteRecords()
  {
    ...
    try
    {
      ...
      while (rslt.next()) {
        clienteRecords.add(new ListarClienteInterno(rslt
          .getString(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
  ...
  public List<BuscarClienteInterno> getClienteByWords(String words)
  {
    ...
    try
    {
      ...
      while (rslt.next()) {
        clienteSearch.add(new BuscarClienteInterno(rslt
          .getString(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
  ...
  public List<RecuperarClienteInterno> getCliente(int id)
  {
    ...
    try
    {
      ...
      while (rslt.next()) {
        clienteGet.add(new RecuperarClienteInterno(rslt
          .getInt(7), rslt
          .getString(1), rslt
          .getString(2), rslt
          .getString(3), rslt
