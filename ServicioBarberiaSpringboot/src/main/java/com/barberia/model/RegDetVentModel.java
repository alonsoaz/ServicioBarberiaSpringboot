...
public class RegDetVentModel
{
  ...
  public static RegDetVentModel getInstance() { if (stdregd == null) {
  ...
  public List<com.barberia.entity.MostrarVentaPorPagar> showVentaXpagar(int idClient)
  {
    ...
    try
    {
      ...
      while (rslt.next()) {
        ShowVxPagar.add(new com.barberia.entity.MostrarVentaPorPagar(rslt
          .getString(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
  ...
  public List<com.barberia.entity.MostrarDetalleVenta> ShowDVxPagar(int idCliente)
  {
    ...
    try
    {
      ...
      while (rslt.next()) {
        ShowDVxPagar.add(new com.barberia.entity.MostrarDetalleVenta(rslt
          .getInt(1), rslt
          .getInt(2), rslt
          .getString(3), rslt
          .getString(4), rslt
  ...
  public List<RecuperarDetalleVenta> getDV(int id)
  {
    ...
    try
    {
      ...
      ResultSet rslt = stmt.executeQuery();
      while (rslt.next()) {
        getDetVenta.add(new RecuperarDetalleVenta(rslt
          .getInt(1), rslt
          .getDouble(2), rslt
          .getInt(3), rslt
          .getDouble(4), rslt
  ...
  public List<MostrarVentaPagada> showVentaPagada(int idClient)
  {
    ...
    try
    {
      ...
      ResultSet rslt = clbl.executeQuery();
      while (rslt.next()) {
        ShowVpagada.add(new MostrarVentaPagada(rslt
          .getInt(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
  ...
  public List<MostrarDetalleVentaPagada> showDetVentaPagada(int idClient, int idVenta)
  {
    ...
    try
    {
      ...
      ResultSet rslt = clbl.executeQuery();
      while (rslt.next()) {
        ShowDVpagada.add(new MostrarDetalleVentaPagada(rslt
          .getString(1), rslt
          .getString(2), rslt
          .getString(3), rslt
          .getString(4), rslt
