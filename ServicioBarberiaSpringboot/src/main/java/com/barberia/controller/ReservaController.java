...
public class ReservaController
{
  ...
  @ResponseBody
  public List<MensajesBeans> askBarbero(@RequestBody ConsultaDisponibilidadBarbero ins, @PathVariable int idBarbero, @PathVariable int idClient, @PathVariable int idServicio)
  {
    ConsultaDisponibilidadBarbero inst = new ConsultaDisponibilidadBarbero(ins.getbYear(), ins.getcMonth(), ins.getdDay(), ins.geteHour(), ins.getfMinut());
  ...
  @ResponseBody
  public List<MensajesBeans> tryBarbero(@RequestBody ConsultaDisponibilidadBarbero ins, @PathVariable int idBarbero, @PathVariable int idClient, @PathVariable int idServicio)
  {
    ConsultaDisponibilidadBarbero inst = new ConsultaDisponibilidadBarbero(ins.getbYear(), ins.getcMonth(), ins.getdDay(), ins.geteHour(), ins.getfMinut());
  ...
  @ResponseBody
  public List<com.barberia.entity.BuscarReservaPorCliente> getReserva(@PathVariable int idClient, @PathVariable int idReserva)
  {
  ...
  @org.springframework.web.bind.annotation.DeleteMapping(value={"/{idClient}/android/reservas/{idReserva}/delete"}, produces={"application/json"}, consumes={"application/json"})
  @ResponseBody
