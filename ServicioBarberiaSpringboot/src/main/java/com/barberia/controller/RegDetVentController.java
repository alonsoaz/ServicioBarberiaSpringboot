...
public class RegDetVentController
{
  ...
  @org.springframework.web.bind.annotation.PostMapping(value={"/{idClient}/android/producto/{idProd}/comprar"}, produces={"application/json"}, consumes={"application/json"})
  @ResponseBody
  public List<MessagenID> registerProducto(@PathVariable int idClient, @PathVariable int idProd, @RequestBody RegistrarDetalleVentaXpAgar ins)
  {
  ...
  @DeleteMapping(value={"/{idClient}/android/carrito/delete"}, produces={"application/json"})
  @ResponseBody
  ...
  @PutMapping(value={"/{idClient}/android/carrito/pagar"}, produces={"application/json"})
  @ResponseBody
  ...
  @PutMapping(value={"/{idClient}/android/carrito/detalle/{id}/update"}, produces={"application/json"}, consumes={"application/json"})
  @ResponseBody
  public List<MensajesBeans> updtDetVent(@PathVariable int idClient, @PathVariable int id, @RequestBody RegistrarDetalleVentaXpAgar ins)
  {
    RegistrarDetalleVentaXpAgar inst = new RegistrarDetalleVentaXpAgar(ins.getCantidad());
  ...
  @DeleteMapping(value={"/{idClient}/android/carrito/detalle/{id}/delete"}, produces={"application/json"}, consumes={"application/json"})
  @ResponseBody
  public List<MensajesBeans> delDV(@PathVariable int idUser, @PathVariable int id)
  {
  ...
  @PutMapping(value={"/{idClient}/android/carrito/detalle/{id}/pagar"}, produces={"application/json"})
  @ResponseBody
  ...
  @GetMapping(value={"/{idClient}/android/compras"}, produces={"application/json"})
  @ResponseBody
  ...
  @GetMapping(value={"/{idClient}/android/compras/{id}/detalle"}, produces={"application/json"})
  @ResponseBody
