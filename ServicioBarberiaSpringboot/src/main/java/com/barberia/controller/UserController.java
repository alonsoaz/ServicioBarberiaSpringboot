...
public class UserController
{
  ...
  {
    InsertarUsuario inst = new InsertarUsuario(ins.getAidUsuario(), ins.getBnombre(), ins.getCapellido(), ins.getDcargo(), ins.getEaka(), ins.getFpass(), ins.getGemail(), ins.getHtelefono(), ins.getIdescripcion());
  ...
  {
    RecuperaraUsuario inst = new RecuperaraUsuario(ins.getAnombre(), ins.getCapellido(), ins.getDcargo(), ins.getEaka(), ins.getFcorreo(), ins.getGtelefono(), ins.getHdescripcion());
